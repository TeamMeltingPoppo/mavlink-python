...
if __name__=="__main__":    
    ...
    threads = [
        threading.Thread(target=connection.run_rx,args=(stop_event,),name="serialport-rx"),
        threading.Thread(target=connection.run_tx,args=(stop_event,),name="serialport-tx"),
